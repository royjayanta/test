<div style="border:none;" class="userpro userpro-<?php echo $i; ?> userpro-<?php echo $layout; ?>" <?php userpro_args_to_data( $args ); ?>>

	<a href="#" class="userpro-close-popup"><?php _e('Close','userpro'); ?></a>
	<!-- <div style="text-align:center; font-size:25px;"><b>WAIT, YOU NEED TO SIGN UP! </b></div> -->
	<br/>
<div style="text-align:center; font-size:15px;"><b>No credit card. No obligation. It's free and takes 30 seconds </b></div>
		...
		<form action="" method="post" data-action="<?php echo $template; ?>">
			...
			<div class="userpro-field userpro-submit userpro-column">
				...
				<input type="submit" value="<?php echo $args["{$template}_button_primary"]; ?>" class="userpro-button" />
              	  <p class="login-txt1">*If you are already registered please click here to login!</p>
				<?php } ?>
