<?php
	...
	function userpro_edit_field( $key, $array, $i, $args, $user_id=null ) {
		...
		*/
		...
		$res .= "<div class='userpro-input text-style'>";
			...
			switch($array['type']) {
				...
				case 'datepicker':
					...
					/*if ( isset($array['hideable']) && $array['hideable'] == 1) {
						...
						$res .= " />".__('Make this field hidden from public1','userpro')."</label>";
					}*/
				...
				case 'text':
					...
					$res .= "<input id='' style='bgcolor:#000000' type='text' name='$key-$i' id='$key-$i' value=".'"'.$value.'"'." placeholder='".$array['placeholder']."' $data />";
