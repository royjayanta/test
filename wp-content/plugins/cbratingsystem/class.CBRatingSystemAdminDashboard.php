                                                ...
                                                if ($defaultFormId != $ratingForm->id) :
                                                    ...
                                                    <tr class="<?php echo $oddEvenClass; ?>">
                                                        <td class="first b b_pages">
                                                            <span><img title="Not Default Form" alt="Not Default Form"
                                                                       src="<?php echo plugins_url('/images/star-off-big.png', __FILE__); ?>"/></span>
                                                        </td>
                                                        <td class="t pages">
                                                        ...
                                                        <td class="t pages">
                                                            ...
                                                            ?>
                                                            <a href="<?php echo $reviewLink; ?>"><span
                                                                    class="count"><?php echo $reviewsCount; ?></span></a>
                                                            <a href="<?php echo $reviewLink; ?>"
                                                               class="<?php echo $class; ?>"><?php echo $reviewsText; ?></a>
                                                        </td>
                                                    </tr>
                                                <?php
                                                else :
                                                    ...
                                                    <tr class="default <?php echo $oddEvenClass; ?>">
                                                        <td class="first b b_pages">
                                                            <span><img title="Default Form" alt="Default Form"
