...
class Cbratinguserlog extends WP_List_Table
{
    ...
    public function prepare_items()
    {
        ...
        /*$sorbys = array(
            'post_type', 'post_id', 'form_id', 'user_id', 'created'
        );*/
        ...
        $data       = CBRatingSystemData::get_user_ratings_with_ratingForm(array($formID), array($postID), array($userID), '', $orderby, $order, $limit, true, $commentID, array($postType));
        $data_total = CBRatingSystemData::get_user_ratings_with_ratingForm_total(array($formID), array($postID), array($userID), '', $orderby, $order, $commentID, array($postType));
