...
class CBRatingSystemTool
{
    ...
    public static function admin_ratingForm_tool_settings()
    {
        ...
        <div class="wrap">
            ...
            <h2><?php _e('CBX Rating & Review:  System Tools', 'cbratingsystem') ?></h2>
    ...
    <?php endif; ?>
        ...
        <form method=post id="dwm_options" action="" enctype="multipart/form-data">
            ...
            <input class="form-checkbox" type="checkbox" name="wdcheckboxalldelete"
                   value="cbdeleteall" <?php get_option('cbratingsystem_deleteonuninstall') == 1 ? print_r("checked='checked'") : '' ?>>
            Yes

            <input class="button button-primary button-large" type=submit name="savebutton"
                   value="<?php _e('Save Option', 'cbratingsystem'); ?>" tabindex="8"><br>
        ...
        <form method=post id="rat_options" action="" enctype="multipart/form-data">
            <input class="button button-primary button-large" type=submit name="resetbutton"
                   value="<?php _e('Reset All', 'cbratingsystem'); ?>" tabindex="8"
                   onclick="return confirm('<?php _e('You are about to reset all previous settings of this plugin .\nThis action is not reversible.\n\n Choose [Cancel] to stop, [OK] to reset.', 'cbratingsystem'); ?>')">
